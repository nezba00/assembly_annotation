...
gff_path <- "../cluster_downloads/assembly.fasta.mod.LTR.intact.raw.gff3"
list_path <- "../cluster_downloads/assembly.fasta.mod.LTR.intact.raw.fa.anno.list"

# Load the data
anno_data=read.table(gff_path,header=F,sep="\t")
head(anno_data)
# Get the classification table
classification=fread(list_path)
